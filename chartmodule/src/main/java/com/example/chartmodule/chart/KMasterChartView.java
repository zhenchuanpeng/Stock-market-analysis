package com.example.chartmodule.chart;
...
import com.example.chartmodule.R;
...
import com.example.chartmodule.data.TechItem;
import com.example.chartmodule.helper.ChartDataSourceHelper;
import com.example.chartmodule.helper.ChartTouchHelper;
import com.example.chartmodule.utils.DateUtils;
import com.example.chartmodule.utils.DisplayUtils;
import com.example.chartmodule.utils.NumFormatUtils;
import com.example.chartmodule.utils.PaintUtils;
  ...
  private void showLongPressDialog(Canvas canvas, RectF contentRect) {
    if (onLongPress) {
      ...
      drawPopText(canvas, popRect, getString(R.string.open), String.valueOf(klineItem.open),
          item.isFall,
          perHeight * 2);
      drawPopText(canvas, popRect, getString(R.string.high), String.valueOf(klineItem.high),
          item.isFall,
          perHeight * 3);
